...
// @author       oralekin - script, LittleEndu - script, ekgame - script, Ender#5769 - image, heshiitou#6303 - toggle, refresh overlay buttons
...
if (window.top !== window.self) {
    window.addEventListener('load', () => {
        ...
        const BUTTON_CONTROLS = document.getElementsByTagName("mona-lisa-embed")[0].shadowRoot.children[0].getElementsByClassName("bottom-controls")[0];

        // Load the image
        const IMG_LINK = 'https://raw.githubusercontent.com/Ender0112/Transgender-Flag-Template/main/place.png';
        ...
        TOGGLE_OVERLAY_BUTTON.onclick = function () {
            ...
            BUTTON_CONTROLS.children[3].shadowRoot.children[0].children[0].style.backgroundColor = IMAGE.hidden ? 'orangered' : null;
        };
        ...
        RELOAD_OVERLAY_BUTTON.onclick = function () { loadImage(); };
